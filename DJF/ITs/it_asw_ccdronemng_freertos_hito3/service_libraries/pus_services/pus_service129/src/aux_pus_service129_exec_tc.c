...
void pus_service129_exec_TC_129_1(tc_handler_t *ptc_handler) {
	...
	// TODO 14 Part1 DONE TC -> FP_x use tc_handler_get_float_appdata_field

	error = tc_handler_get_float_appdata_field(ptc_handler, &FP_x);

	// TODO 14 Part2 DONE -> FP_y use tc_handler_get_float_appdata_field

	error += tc_handler_get_float_appdata_field(ptc_handler, &FP_y);

	// TODO 14 Part3 DONE TC -> FP_z use tc_handler_get_float_appdata_field
